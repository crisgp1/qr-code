        ...
        <button
          ...
          className={`text-left px-3 py-2 rounded-lg text-sm transition-all ${
            currentTemplateId === tmpl.id
              ...
              : 'bg-gray-50 dark:bg-gray-700 text-[var(--text-secondary)] hover:bg-gray-100 dark:hover:bg-gray-600'
          }`}
        >
          <div className="font-semibold">{getTranslated(t, tmpl.labelKey)}</div>
          <div className={`text-[11px] ${currentTemplateId === tmpl.id ? 'text-white/70' : 'text-[var(--text-muted)]'}`}>
